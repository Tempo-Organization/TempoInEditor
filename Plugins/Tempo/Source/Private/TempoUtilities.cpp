...
void UTempoUtilities::LaunchExternalExecutable(const FString& FilePath, const TArray<FString>& Parameters)
{
...
void UTempoUtilities::LaunchExternalExecutableNoHead(const FString& FilePath, const TArray<FString>& Parameters)
{
    FString Command = FString::Printf(TEXT("\"%s\""), *FilePath);
...
FString UTempoUtilities::GetProjectDirectory()
{
...
TArray<FString> UTempoUtilities::GetFilesInDirectoryTree(const FString& Directory)
{
...
TArray<FString> UTempoUtilities::GetFileExtensionsFromPaths(const TArray<FString>& FilePaths)
{
...
bool UTempoUtilities::CreateDirectory(const FString& Directory)
{
    return IFileManager::Get().MakeDirectory(*Directory, true);
}

bool UTempoUtilities::DeleteDirectoryAndContents(const FString& Directory)
{
    IFileManager& FileManager = IFileManager::Get();
...
bool UTempoUtilities::DoesDirectoryExist(const FString& Directory)
{
    IFileManager& FileManager = IFileManager::Get();
    return FileManager.DirectoryExists(*Directory);
}

bool UTempoUtilities::DoesFileExist(const FString& File)
{
    IFileManager& FileManager = IFileManager::Get();
    return FileManager.FileExists(*File);
}

bool UTempoUtilities::CopyFile(const FString& BeforeFile, const FString& AfterFile)
{
    IFileManager& FileManager = IFileManager::Get();
...
bool UTempoUtilities::DeleteFile(const FString& File)
{
    IFileManager& FileManager = IFileManager::Get();
...
FString UTempoUtilities::DataTableToJson(UDataTable* DataTable)
{
    if (!DataTable)
    {
...
bool UTempoUtilities::JsonToDataTable(const FString& JsonString, UDataTable* DataTable)
{
    if (!DataTable)
    {
        UE_LOG(LogTemp, Warning, TEXT("DataTable is null"));
...
bool UTempoUtilities::CreateTextFile(const FString& FileName, const FString& FileContents)
{
...
FString UTempoUtilities::ReadFile(const FString& FileName)
{
...
TArray<FString> UTempoUtilities::GetFunctionNames(UObject* Object)
{
...
void UTempoUtilities::CallFunctionByName(UObject* Object, const FString& FunctionName)
{
    if (!Object)
    {
        UE_LOG(LogTemp, Warning, TEXT("Object is null"));
...
TArray<UObject*> UTempoUtilities::GetAllInstancedObjectsOfClass(UClass* Class)
{
...
TArray<FString> UTempoUtilities::GetEnumValuesAsString(UEnum* Enum)
{
...
void UTempoUtilities::OpenDirectory(FString DirectoryPath)
{
...
void UTempoUtilities::OpenWebsite(FString URL)
{
    FPlatformProcess::LaunchURL(*URL, nullptr, nullptr);
}

bool UTempoUtilities::WriteStringToFile(const FString& FileName, const FString& FileContents)
{
...
bool UTempoUtilities::SetJsonFieldAsString(const FString& JsonString, const TArray<FString>& FieldNames, const FString& FieldValue, FString& OutJsonString)
{
...
bool UTempoUtilities::GetJsonFieldAsString(const FString& JsonString, const TArray<FString>& FieldNames, FString& FieldValue)
{
    TSharedRef<TJsonReader<>> Reader = TJsonReaderFactory<>::Create(JsonString);
    TSharedPtr<FJsonObject> JsonObject;
...
bool UTempoUtilities::RemoveJsonField(const FString& JsonString, const TArray<FString>& FieldNames, FString& OutJsonString)
{
    TSharedPtr<FJsonObject> JsonObject;
    TSharedRef<TJsonReader<>> Reader = TJsonReaderFactory<>::Create(JsonString);
...
bool UTempoUtilities::ReadJsonField(const FString& JsonString, const TArray<FString>& FieldNames, FString& FieldValue)
{
    return GetJsonFieldAsString(JsonString, FieldNames, FieldValue);
}

bool UTempoUtilities::AddJsonListEntry(const FString& JsonString, const TArray<FString>& FieldNames, const FString& EntryValue, FString& OutJsonString)
{
    TSharedPtr<FJsonObject> JsonObject;
    TSharedRef<TJsonReader<>> Reader = TJsonReaderFactory<>::Create(JsonString);
...
bool UTempoUtilities::RemoveJsonListEntry(const FString& JsonString, const TArray<FString>& FieldNames, int32 Index, FString& OutJsonString)
{
    TSharedPtr<FJsonObject> JsonObject;
    TSharedRef<TJsonReader<>> Reader = TJsonReaderFactory<>::Create(JsonString);
...
bool UTempoUtilities::CheckIfJsonFieldExists(const FString& JsonString, const TArray<FString>& FieldNames, bool& Exists)
{
    TSharedPtr<FJsonObject> JsonObject;
    TSharedRef<TJsonReader<>> Reader = TJsonReaderFactory<>::Create(JsonString);
...
bool UTempoUtilities::GetJsonArrayEntries(const FString& JsonString, const TArray<FString>& FieldNames, TArray<FString>& Entries)
{
    TSharedPtr<FJsonObject> JsonObject;
    TSharedRef<TJsonReader<>> Reader = TJsonReaderFactory<>::Create(JsonString);
...
FString UTempoUtilities::GetParentDirectory(const FString& FilePath)
{
